...
class taskAddress extends AsyncTask<Location, Void, String> {
    ...
    taskAddress(com.example.a003005121utsga.TitikLokasi applicationContext, OnTaskCompleted listener) {
    ...
    protected String doInBackground(Location... params) {
        ...
        try {
            ...
            resultMessage = mContext.getString(R.string.service_unavailable);
